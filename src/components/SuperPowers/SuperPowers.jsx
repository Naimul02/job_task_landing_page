    ...
    return (
        <div data-aos="fade-up">
           ...
           <div className="flex flex-row gap-28 md:gap-10 lg:gap-28 justify-center md:mx-12 lg:mx-0 mt-10">
            ...
            <div><img src={img3} className="w-28 h-20"alt="Mongodb"></img></div>
            
           <div><img src={img1} className="w-20 h-20" alt="remix"></img></div>
         ...
         <div className="flex flex-col  md:flex-row md:items-center md:justify-center space-y-10 md:gap-10 lg:gap-28 md:space-y-0">
           ...
           <div><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfQ4MH3vLA6l72ULn3Up_6undPBcXoERMFcA&s" className="w-16 h-16 rounded-xl" alt="javascript"></img></div>
